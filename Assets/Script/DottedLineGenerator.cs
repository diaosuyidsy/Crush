...
public class DottedLineGenerator : MonoBehaviour
{
	...
	// int i, Collider2D hitcollider, ref bool firstentry, ref Vector3 pos, ref float temp_dis, ref Vector3 pStartPosition
	// ,ref bool first_time_portal, ref float fTime, Vector3 bulletVelocity, Vector3 wind_center, Vector3 wind_extents
